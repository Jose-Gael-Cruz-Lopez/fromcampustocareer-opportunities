        ...
        <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-2 text-sm font-medium text-emerald-700 dark:text-emerald-400">
              ...
              <span>From Campus to Career</span>
            </div>
            <h1 className="max-w-3xl text-balance text-3xl font-semibold leading-tight tracking-tight text-zinc-950 dark:text-zinc-50 sm:text-4xl lg:text-5xl">
              Opportunities that take you from campus to career.
            </h1>
            <p className="max-w-2xl text-base leading-relaxed text-zinc-600 dark:text-zinc-400">
              Internships, fellowships, research, scholarships, and early-career
              pipelines — one community-curated list, updated daily.
            </p>
            <div className="mt-2 flex flex-wrap gap-3 text-sm">
              <a
                href="https://github.com/Jose-Gael-Cruz-Lopez/fromcampustocareer-opportunities"
                target="_blank"
              ...
              <a
                href="https://github.com/Jose-Gael-Cruz-Lopez/fromcampustocareer-opportunities/issues/new/choose"
                target="_blank"
                rel="noopener noreferrer"
